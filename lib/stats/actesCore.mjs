...
function yearOf(iso) {
  if (!iso) return null
  // Lire l'année lexicalement (comme dayOf) : new Date('YYYY-01-01') est
  // interprété en UTC, donc un acte de janvier bascule sur l'année précédente
  // dans un fuseau derrière UTC.
