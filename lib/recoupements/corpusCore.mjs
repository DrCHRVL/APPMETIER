// lib/recoupements/corpusCore.mjs
//
// CE QUE LES RECOUPEMENTS ONT LE DROIT DE LIRE.
//
...
function pousser(fragments, fragment) {
 ...
 */
function signatureEnquete(enquete, documentTexts) {
...
export async function buildCorpus(
  ...
  const prelimRattachees = new Map();
  /** Préliminaire retrouvée, prête à être versée dans son instruction. */
  const prelimParInstruction = new Map();
