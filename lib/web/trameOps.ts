/**
 * SIRAL — moteur d'ÉDITION des trames de forme au format Word (.docx).
 * (Le jumeau OpenDocument vit dans `trameOdt.ts` ; `trameDoc.ts` aiguille.)
 *
...
import { zipVersBase64 } from './zipSortie';
