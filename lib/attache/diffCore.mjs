 ...
 *
 * Module PARTAGÉ (pur, sans dépendance) : le service attaché l'importe en
 * relatif depuis scripts/attache/, le panneau web via @/lib/attache/ pour
 * montrer au magistrat la liste des changements d'une proposition de méthode.
 */
