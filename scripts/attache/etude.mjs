...
export function etudePrompt(trigger) {
  return [
    ...
    '     les trames préfixées modele- sont les tiennes. TOUTE AUTRE trame (déposée par le magistrat) reste',
    '     INTOUCHABLE : compare-la au corpus et consigne les écarts utiles dans le livrable, rien de plus.',
    ...
    'livrable d\'une ligne le disant. Ce run étudie : il ne traite aucun dossier, ne propose rien, n\'écrit rien',
    'd\'autre que trames modele-*, mémoire et livrable.',
  ].join('\n')
}
