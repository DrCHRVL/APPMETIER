...
export function systemPrompt(keys) {
  ...
  return [
    ...
    '3. DATES ET DURÉES : une autorisation dont la durée légale ou la date de fin ne colle pas avec ce que SIRAL affiche → recalcule, dis lequel a raison et pourquoi (cf. rôle majordome).',
