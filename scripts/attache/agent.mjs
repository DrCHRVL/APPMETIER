...
export function systemPrompt(keys) {
  ...
  return [
    ...
    '4bis. RECOUPE LES IDENTIFIANTS FORTS dès le rangement — c\'est AU TÉLÉVERSEMENT que les coquilles doivent se voir. Extrais de la pièce les plaques, lignes téléphoniques, IMEI et adresses, puis compare-les à ceux DÉJÀ enregistrés au dossier (actes, géoloc, écoutes, description). Si un identifiant DIFFÈRE LÉGÈREMENT d\'un identifiant connu — coquille probable, un seul chiffre/lettre d\'écart (ex. ligne …71.84 vs …71.85, plaque EM-391-YN vs EM-319-YN, IMEI en …0752 vs …0762) — SIGNALE-le immédiatement (signaler + item verification « à vérifier vous seul ») AVANT toute exploitation, et NE rédige AUCUN acte fondé sur cet identifiant tant que le magistrat n\'a pas tranché. Deux identifiants francs et nettement différents = deux objets distincts (ne les fusionne pas). Signale de même une date de pose indiquée par l\'enquêteur qui diverge de celle enregistrée dans SIRAL.',
